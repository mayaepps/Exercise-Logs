...
def get_x_y(data):
    ...
    for sent_id in data:
        ...
        sents.append(exercise_tokens) # TODO: compare to score with all tokens
    return sents, labels
...
if __name__ == '__main__':
    ...
    # logistic regression and random forest get 1-2% accuracy on validation set
    ...
    # TODO: exact word matching (using textblob_tokenizer) baseline
    # TODO: edit distance baseline
    # TODO: evaluate best models on test set, averaging scores over 5-10 runs
